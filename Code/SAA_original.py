...
def original_sample_average_approximation( set_NO , params , earthquake_info = None):
            ...
            for l in range(num_candidates_launch_points):
                ...
                for i in range(num_gathering_points):
                    ...
                    if air_speed_SD == 0:
                        ...
                        total_airtime += x[s,i,l,k] * (2 * distance / air_speed_SD + tau)
            ...
            for l in range(num_candidates_depots):
                ...
                for i in range(num_gathering_points):
                    ...
                    if air_speed_SD == 0:
                        ...
                        total_airtime += x[s,i,l+num_candidates_launch_points,k] * (2 * distance / air_speed_SD + tau)
            ...
            for d in range(num_candidates_depots):
                ...
                for i in range(num_gathering_points):
                    ...
                    if air_speed_SD == 0:
                        ...
                        total_airtime += y[s,i,d,k] * 2 * distance / air_speed_LD
                m.addConstr( total_airtime <= T )
    ...
    return m.ObjVal , final_time-current_time ,(u_values,v_values,w_values) , (g_SD_values , g_LD_values)